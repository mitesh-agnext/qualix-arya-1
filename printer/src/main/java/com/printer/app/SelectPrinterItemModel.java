...
@EpoxyModelClass(layout = R2.layout.item_select_printer)
public abstract class SelectPrinterItemModel extends EpoxyModelWithHolder<SelectPrinterItemModel.Holder> {
