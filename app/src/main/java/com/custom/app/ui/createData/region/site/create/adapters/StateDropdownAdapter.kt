...
class StateDropdownAdapter: BaseAdapter {

    private var mContext: Context? = null
    private var stateList: ArrayList<StateRes>? = null

    constructor(context: Context, stateList: ArrayList<StateRes>) : super() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        try {
            holder.tvTitleName!!.text = "${stateList!![position].state_name}"
