...
import com.funrisestudio.stepprogress.ArcView
import com.funrisestudio.stepprogress.DrawableHelper
import com.funrisestudio.stepprogress.SViewUtils
import com.funrisestudio.stepprogress.StepState
...
class StepProgressView : ViewGroup {
    ...
    private fun init() {
        ...
        checkedDrawable = createCheckDrawable(context, nodeColor)
    ...
    fun createCheckDrawable(context: Context, color: Int): Drawable {
        val checkDrawable = context.getDrawable(R.drawable.ic_check_white_24dp)
        return LayerDrawable(arrayOf(drawableHelper.createOvalDrawable(color), checkDrawable)).apply {
    ...
    fun selectStep(step: Int) {
        return stepProgress.selectStep(step)
    }
